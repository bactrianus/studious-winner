package com.groupdocs.ui.model.helper;
...
import com.groupdocs.ui.model.GetImageUrlsParameters;
import com.groupdocs.ui.model.ViewDocumentParameters;
...
public final class ImageUrlHelper
 {
		...
		public static String[] GetImageUrls(String applicationHost, int[] pageNumbers, ViewDocumentParameters parameters)
		{
		 ...
		 private static String[] GetImageUrls(String applicationHost, String path, int startingPageNumber, int pageCount, Integer pageWidth, Integer quality, boolean usePdf, String watermarkText, Integer watermarkColor, com.groupdocs.ui.model.WatermarkPosition watermarkPosition, Float watermarkWidth, boolean ignoreDocumentAbsence, boolean useHtmlBasedEngine, boolean supportPageRotation, String instanceId, String locale, int[] pageNumbers)
		 {
					String[] pageUrls = new String[pageCount];
					 HashMap<String, Object> routeValueDictionary2 = new HashMap<String, Object>();
						...
						if (!com.groupdocs.ui.model.helper.DotNetToJavaStringHelper.isNullOrWhiteSpace(locale))
						{
							routeValueDictionary2.put("locale", locale);
						}

						if (!com.groupdocs.ui.model.helper.DotNetToJavaStringHelper.isNullOrEmpty(watermarkText))
						{
						...
						if (!com.groupdocs.ui.model.helper.DotNetToJavaStringHelper.isNullOrWhiteSpace(instanceId))
						{
		 ...
		 private static String CreateRelativeRequestUrl(String actionName, HashMap<String, Object> routeValueDictionary2)
		 {
					...
					{
						if (com.groupdocs.ui.model.helper.DotNetToJavaStringHelper.isNullOrWhiteSpace(oneRoute.getKey()) || oneRoute.getValue() == null || com.groupdocs.ui.model.helper.DotNetToJavaStringHelper.isNullOrWhiteSpace(oneRoute.getValue().toString()))
						{
							continue;
						}
